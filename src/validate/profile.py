...
print(" ")
print(f"Total duplicate count = {rule_duplicate_ids(df).shape[0]+rule_duplicate_rows(df).shape[0]}. Some might be counted twice")
print(" ")
print(" ")

print("Invalid value count:")
print(rule_valid_date(df))
print(f"Total invalid value row count: {rule_valid_date(df).shape[0]}")
print(" ")
print(" ")
